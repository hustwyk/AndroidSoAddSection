...
public class ElfType32 {
    ...
    public int sectionHeaderSize = 40;
    ...
    public static class elf32_shdr{
        ...
        public int length(){
            return sh_name.length + sh_type.length + sh_flags.length + sh_addr.length
                    + sh_offset.length + sh_size.length + sh_link.length
                    + sh_info.length + sh_addralign.length + sh_entsize.length;
        }
    }
